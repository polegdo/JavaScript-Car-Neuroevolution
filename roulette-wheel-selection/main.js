...
function startNewExperiment(){
	...
	experimentAvgBestFitnessDistance=0;
...
function restart(){
	...
	else
	{
		...
		matingPool=[];
		for(let i=0;i<cars.length;i++){
			let rouletteSelection=selectCarFromRouletteWheel(totalFitness);
			matingPool.push(rouletteSelection);
		}
...
function selectCarFromRouletteWheel(totalFitness)
{
    let n=getRandomIntInclusive(0,totalFitness);
    let i = 0;
    let P = 0;
